...
'Prox1' : 'P_sequential_hyperplane_odd',# 'P_parallel_hyperplane', # 'P_sequential_hyperplane_odd', # projection onto support and nonnegativity constraint
'Prox2' :'P_sequential_hyperplane_even', #'P_Diag', #'P_sequential_hyperplane_even', # projection onto mask constraint
...
# HAAR, HPR and RAAR)
'beta_max' : 0.6,   # maximum relaxation prameter (only used with
# HAAR, RAAR, and HPR)
